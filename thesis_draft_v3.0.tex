...
\newpage
\section*{Appendix X: Y5 v1.3 Master Synthesis}
\addcontentsline{toc}{section}{Appendix X}

The Y5 v1.3 master synthesis paper (89 pages) is reproduced here as Appendix X.
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep)}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep)}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep)}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep)}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep)}
